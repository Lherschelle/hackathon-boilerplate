...
function normaliseString(e, t) {
  const n = e ? e.trim() : "";
  let i,
    s = null == t ? void 0 : t.type;
  switch (
    (s ||
      (["true", "false"].includes(n) && (s = "boolean"),
      n.length > 0 && isFinite(Number(n)) && (s = "number")),
    s)
  ) {
    case "boolean":
      i = "true" === n;
...
function extractConfigByNamespace(e, t, n) {
  ...
  for (const [o, r] of Object.entries(t)) {
    ...
    for (const [i, s] of t.entries())
      "object" == typeof e &&
        (i < t.length - 1
          ? (isObject(e[s]) || (e[s] = {}), (e = e[s]))
          : o !== n && (e[s] = normaliseString(r)));
  }
  return s[n];
}
...
function setFocus(e, t = {}) {
  ...
  i || e.setAttribute("tabindex", "-1"),
    e.addEventListener(
      "focus",
      function () {
        e.addEventListener("blur", onBlur, { once: !0 });
      },
      { once: !0 },
    ),
...
function normaliseDataset(e, t) {
  const n = {};
  for (const [i, s] of Object.entries(e.schema.properties))
    i in t && (n[i] = normaliseString(t[i], s)),
      "object" === (null == s ? void 0 : s.type) &&
        (n[i] = extractConfigByNamespace(e, t, i));
  return n;
}
...
class I18n {
  constructor(e = {}, t = {}) {
    ...
    (this.translations = void 0),
      ...
      (this.translations = e),
      (this.locale =
        null != (n = t.locale) ? n : document.documentElement.lang || "en");
  }
  t(e, t) {
    if (!e) throw new Error("i18n: lookup key missing");
    let n = this.translations[e];
    if (
      "number" == typeof (null == t ? void 0 : t.count) &&
      "object" == typeof n
    ) {
  ...
  replacePlaceholders(e, t) {
    ...
    return e.replace(/%{(.\S+)}/g, function (e, i) {
      if (Object.prototype.hasOwnProperty.call(t, i)) {
        const e = t[i];
        return !1 === e || ("number" != typeof e && "string" != typeof e)
          ? ""
          : "number" == typeof e
            ? n
              ? n.format(e)
      ...
      throw new Error(
        `i18n: no data found to replace ${e} placeholder in string`,
      );
    });
  }
  ...
  getPluralSuffix(e, t) {
    ...
    const n = this.translations[e],
      i = this.hasIntlPluralRulesSupport()
        ? new Intl.PluralRules(this.locale).select(t)
        : this.selectPluralFormUsingFallbackRules(t);
    if ("object" == typeof n) {
      if (i in n) return i;
      if ("other" in n)
        return (
          console.warn(
            `i18n: Missing plural form ".${i}" for "${this.locale}" locale. Falling back to ".other".`,
          ),
          "other"
        );
    }
      ...
      1 === e || 11 === e
        ...
        : 2 === e || 12 === e
          ...
          : (e >= 3 && e <= 10) || (e >= 13 && e <= 19)
            ...
            : "other",
    spanish: (e) =>
      1 === e ? "one" : e % 1e6 == 0 && 0 !== e ? "many" : "other",
    welsh: (e) =>
      0 === e
        ? "zero"
        : 1 === e
...
class Accordion extends GOVUKFrontendComponent {
  constructor(e, t = {}) {
    ...
    (this.$module = e),
      (this.config = mergeConfigs(
        Accordion.defaults,
        t,
        normaliseDataset(Accordion, e.dataset),
      )),
  ...
  initControls() {
    ...
    e.setAttribute("class", this.controlsClass),
      ...
      "onbeforematch" in document &&
        document.addEventListener("beforematch", (e) => this.onBeforeMatch(e));
  }
  initSectionHeaders() {
    this.$sections.forEach((e, t) => {
      ...
      this.constructHeaderMarkup(n, t),
        this.setExpanded(this.isExpanded(e), e),
        n.addEventListener("click", () => this.onSectionToggle(e)),
  ...
  constructHeaderMarkup(e, t) {
    ...
    o.setAttribute("type", "button"),
      o.setAttribute("aria-controls", `${this.$module.id}-content-${t + 1}`);
    for (const d of Array.from(n.attributes))
    ...
    a.classList.add(this.sectionHeadingTextFocusClass),
      r.appendChild(a),
      Array.from(n.childNodes).forEach((e) => a.appendChild(e));
    ...
    if (
      (u.classList.add(this.upChevronIconClass),
      c.appendChild(u),
      ...
      Array.from(s.childNodes).forEach((e) => t.appendChild(e)),
        s.remove(),
        o.appendChild(e),
        o.appendChild(this.getButtonPunctuationEl());
    }
    ...
    a.push(h),
      ...
      e
        ? (o.removeAttribute("hidden"),
          t.classList.add(this.sectionExpandedClass),
          n.classList.remove(this.downChevronIconClass))
        : (o.setAttribute("hidden", "until-found"),
          t.classList.remove(this.sectionExpandedClass),
  ...
  updateShowAllButton(e) {
    this.$showAllButton &&
      this.$showAllText &&
      this.$showAllIcon &&
      (this.$showAllButton.setAttribute("aria-expanded", e.toString()),
      (this.$showAllText.textContent = e
        ? this.i18n.t("hideAllSections")
        : this.i18n.t("showAllSections")),
      this.$showAllIcon.classList.toggle(this.downChevronIconClass, !e));
  }
  getIdentifier(e) {
  ...
  getButtonPunctuationEl() {
    const e = document.createElement("span");
    return (
      e.classList.add("govuk-visually-hidden", this.sectionHeadingDividerClass),
      (e.textContent = ", "),
      e
    );
  }
  ...
  constructor(e, t = {}) {
    ...
    (this.$module = e),
      (this.config = mergeConfigs(
        Button.defaults,
        t,
        normaliseDataset(Button, e.dataset),
      )),
      this.$module.addEventListener("keydown", (e) => this.handleKeyDown(e)),
      this.$module.addEventListener("click", (e) => this.debounce(e));
  }
  handleKeyDown(e) {
    const t = e.target;
    " " === e.key &&
...
class CharacterCount extends GOVUKFrontendComponent {
  constructor(e, t = {}) {
    ...
    let r = {};
    ("maxwords" in o || "maxlength" in o) &&
      (r = { maxlength: void 0, maxwords: void 0 }),
    ...
    const a = (function (e, t) {
      ...
      for (const [i, s] of Object.entries(e)) {
        const e = [];
        if (Array.isArray(s)) {
          for (const { required: n, errorMessage: i } of s)
            n.every((e) => !!t[e]) || e.push(i);
    ...
    `${c.textContent}`.match(/^\s*$/) &&
      (c.textContent = this.i18n.t("textareaDescription", {
        count: this.maxLength,
      })),
      this.$textarea.insertAdjacentElement("afterend", c);
    const h = document.createElement("div");
    (h.className = "govuk-character-count__sr-status govuk-visually-hidden"),
      h.setAttribute("aria-live", "polite"),
      (this.$screenReaderCountMessage = h),
      c.insertAdjacentElement("afterend", h);
    const u = document.createElement("div");
    (u.className = c.className),
      u.classList.add("govuk-character-count__status"),
      u.setAttribute("aria-hidden", "true"),
      (this.$visibleCountMessage = u),
      c.insertAdjacentElement("afterend", u),
      c.classList.add("govuk-visually-hidden"),
  ...
  updateVisibleCountMessage() {
    ...
    this.$visibleCountMessage.classList.toggle(
      ...
      this.$textarea.classList.toggle("govuk-textarea--error", e),
      this.$visibleCountMessage.classList.toggle("govuk-error-message", e),
      this.$visibleCountMessage.classList.toggle("govuk-hint", !e),
  ...
  formatCountMessage(e, t) {
    ...
    return this.i18n.t(`${t}${n}`, { count: Math.abs(e) });
  }
  isOverThreshold() {
...
class Checkboxes extends GOVUKFrontendComponent {
  constructor(e) {
    ...
    (this.$module = e),
      ...
      this.syncAllConditionalReveals(),
      this.$module.addEventListener("click", (e) => this.handleClick(e));
  }
  ...
  syncConditionalRevealWithInputState(e) {
    ...
    if (null != n && n.classList.contains("govuk-checkboxes__conditional")) {
      ...
      e.setAttribute("aria-expanded", t.toString()),
        n.classList.toggle("govuk-checkboxes__conditional--hidden", !t);
    }
  }
  unCheckAllInputsExcept(e) {
    document
      .querySelectorAll(`input[type="checkbox"][name="${e.name}"]`)
      .forEach((t) => {
        e.form === t.form &&
          t !== e &&
  ...
  unCheckExclusiveInputs(e) {
    document
      .querySelectorAll(
        `input[data-behaviour="exclusive"][type="checkbox"][name="${e.name}"]`,
      )
      .forEach((t) => {
        e.form === t.form &&
          ((t.checked = !1), this.syncConditionalRevealWithInputState(t));
  ...
  handleClick(e) {
    ...
    if (
      ...
      return;
    "exclusive" === t.getAttribute("data-behaviour")
      ? this.unCheckAllInputsExcept(t)
      : this.unCheckExclusiveInputs(t);
  }
}
...
class ErrorSummary extends GOVUKFrontendComponent {
  constructor(e, t = {}) {
    ...
    (this.$module = e),
      (this.config = mergeConfigs(
        ...
        t,
        normaliseDataset(ErrorSummary, e.dataset),
      )),
      this.config.disableAutoFocus || setFocus(this.$module),
      this.$module.addEventListener("click", (e) => this.handleClick(e));
  }
  handleClick(e) {
    const t = e.target;
  ...
  getAssociatedLegendOrLabel(e) {
    ...
    return null !=
      (t = document.querySelector(`label[for='${e.getAttribute("id")}']`))
      ? t
      : e.closest("label");
  }
}
...
class ExitThisPage extends GOVUKFrontendComponent {
  constructor(e, t = {}) {
    ...
    (this.config = mergeConfigs(
      ...
      t,
      normaliseDataset(ExitThisPage, e.dataset),
    )),
      (this.i18n = new I18n(this.config.i18n)),
      (this.$module = e),
      (this.$button = n);
  ...
  handleKeypress(e) {
    this.$updateSpan &&
      ("Shift" !== e.key || this.lastKeyWasModified
  ...
  resetKeypressTimer() {
    ...
    (this.keypressCounter = 0),
      (e.textContent = this.i18n.t("timedOut")),
  ...
  constructor(e, t = {}) {
    ...
    (this.$module = e),
      (this.config = mergeConfigs(
        ...
        t,
        normaliseDataset(NotificationBanner, e.dataset),
      )),
      "alert" !== this.$module.getAttribute("role") ||
  ...
  constructor(e, t = {}) {
    ...
    (this.$module = e),
      ...
      (this.config = mergeConfigs(
        ...
        t,
        normaliseDataset(PasswordInput, e.dataset),
      )),
      (this.i18n = new I18n(this.config.i18n, {
        locale: closestAttributeValue(e, "lang"),
      })),
...
class Radios extends GOVUKFrontendComponent {
  ...
  syncConditionalRevealWithInputState(e) {
    ...
    if (null != n && n.classList.contains("govuk-radios__conditional")) {
      const t = e.checked;
      e.setAttribute("aria-expanded", t.toString()),
        n.classList.toggle("govuk-radios__conditional--hidden", !t);
    }
  }
  handleClick(e) {
    const t = e.target;
...
class SkipLink extends GOVUKFrontendComponent {
  constructor(e) {
    var t;
    if ((super(), (this.$module = void 0), !(e instanceof HTMLAnchorElement)))
      throw new ElementError({
    ...
    try {
      ...
      throw new ElementError(
        `Skip link: Target link (\`href="${i}"\`) is invalid`,
      );
    }
    if (
    ...
    if (!o)
      throw new ElementError(
        `Skip link: Target link (\`href="${i}"\`) has no hash fragment`,
      );
...
class Tabs extends GOVUKFrontendComponent {
    ...
    this.$tabList.setAttribute("role", "tablist"),
      ...
      this.$tabs.forEach((e) => {
        this.setAttributes(e),
          e.addEventListener("click", this.boundTabClick, !0),
          e.addEventListener("keydown", this.boundTabKeydown, !0),
          this.hideTab(e);
      });
    const t =
      null != (e = this.getTab(window.location.hash)) ? e : this.$tabs[0];
    this.showTab(t),
  ...
  teardown() {
    this.$tabList.removeAttribute("role"),
      ...
      this.$tabs.forEach((e) => {
        e.removeEventListener("click", this.boundTabClick, !0),
          e.removeEventListener("keydown", this.boundTabKeydown, !0),
  ...
  activateNextTab() {
    ...
    n &&
      (this.hideTab(e), this.showTab(n), n.focus(), this.createHistoryEntry(n));
  }
  activatePreviousTab() {
    const e = this.getCurrentTab();
    if (null == e || !e.parentElement) return;
  ...
  unhighlightTab(e) {
    e.parentElement &&
      (e.setAttribute("aria-selected", "false"),
      e.parentElement.classList.remove("govuk-tabs__list-item--selected"),
      e.setAttribute("tabindex", "-1"));
  }
  highlightTab(e) {
    e.parentElement &&
      (e.setAttribute("aria-selected", "true"),
      e.parentElement.classList.add("govuk-tabs__list-item--selected"),
...
function initAll(e) {
  var t;
  if (((e = void 0 !== e ? e : {}), !isSupported()))
    return void console.log(new SupportError());
  const n = [
